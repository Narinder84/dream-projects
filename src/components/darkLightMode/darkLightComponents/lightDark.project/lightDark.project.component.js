			...
			<div className='project-container'>
				<div className='project-section'>
					<div className='project-row'>
						<div className='image-container-1 pro' id='image-container-1'>
						...
						<div className='description'>
							<div
								...
								<p>
									...
									are created with class and functional concepts of React. All
									UIs are created using CSS3, CSS-Grid, and Flex-Box.
									React-Router is implemented for smooth navigation. Managed
									state and API calls with Readux-Thunk. State persistence is
									implemented in the web app with local storage for batter user
									experience. Optimized app using React-lazy and reselect
									library with Redux. Deployed on heroku.<br></br>{' '}
									<span className='in'>Live project :- </span>
						...
						<div className='description'>
							<div
								...
								<p>
									...
									Back end created with Nodejs Express. Hooked with Postgres.
									REST API’s methodology used to connect with client. Passwords
					...
					<div className='project-row'>
						...
						<div className='description'>
							<div
								...
								<p>
									UIs created with React.All components are create by using
									HTML5, CSS3, CSS-Grid. No third party libraries used. These
									projects are create using AIPs.
									<br></br>
